  ...
  return (
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 relative z-10">
        ...
        <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center text-slate-900">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {caseCards.map((card) => (
            <div key={card.title} className="rounded-xl border border-slate-200 bg-slate-100/90 p-3 shadow-sm">
              <div className="mb-4 flex items-center justify-center rounded-xl bg-white p-3 shadow-sm">
                <img
                  src={card.image}
                  alt={card.title}
